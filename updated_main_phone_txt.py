...
# Read phone number and amount from phone.txt
def read_phone_data():
    try:
...
phone, num = read_phone_data()
if not phone or not num:
    print("Failed to retrieve phone number or amount from phone.txt")
    exit()
